    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="sidebarCollapse">
            ...
            <ul class="navbar-nav mb-3">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/business/call_to_actions') }}">
                        <i class="fe fe-briefcase"></i> Call To Action
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/business/reviews') }}">
                        <i class="fe fe-star"></i> Reviews
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/business/photos_videos') }}">
                        <i class="fe fe-edit"></i> Photos & Videos
                    </a>
                </li>
            </ul>
