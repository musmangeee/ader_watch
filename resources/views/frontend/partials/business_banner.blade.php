                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item pr-lg-2">
                            <a href="{{ route('ads.create') }}" class="nav-link text-dark">Upload New Ad</a>
                        </li>
                        <li class="nav-item pr-lg-3">
                            <a href="{{ route('ads.index') }}" class="nav-link text-dark">My Ads</a>
                        </li>
                        ...
                        @guest
                            ...
                            <li class="nav-item">
                                <a href="{{route('login')}}" class="nav-link">Library</a>
                            </li>

                            <li class="nav-item">
                                <a href="{{route('login')}}" class="nav-link">Shuffle</a>
                            </li>

                            <li class="nav-item border-right-2">
                                <a href="{{route('login')}}" class="nav-link">Ad upload</a>
                            </li>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-lg-right">
                                    <li><a class="dropdown-item" href="{{ url('home') }}"><i class="fa fa-user pr-2"></i>Dashboard</a></li>
                                    <li><a class="dropdown-item" href="{{ url('business/reviews') }}"><i class="fa fa-star pr-2"></i>My Reviews</a></li>
                                    <li><a class="dropdown-item" href="{{ url('business/setting') }}"><i class="fa fa-sign pr-2"></i>Account Settings</a></li></li>
